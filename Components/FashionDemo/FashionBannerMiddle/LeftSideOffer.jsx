            ...
            <Row className='gy-4' key={i}>
              <Col lg='12' className='ratio_40'>
                <div className='collection-banner p-left banner-title'>
                  <Link href='/shop/shop-page' className='banner-img'>
                  ...
                  <div className='banner-text'>
                    <div className='banner-content'>
                      ...
                      <Btn attrBtn={{ className: 'btn-solid-default', onClick: () => router.push('/shop/shop-page') }}>{ShopNow}</Btn>
                    </div>
                  </div>
                </div>
              </Col>
                ...
                return (
                  <Col sm='6' className='ratio2_3' key={i}>
                    <div className='collection-banner p-center text-center'>
                      ...
                      <Link href='/shop/shop-page' className='contain-banner'>
